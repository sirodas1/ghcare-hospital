                    ...
                    <form action="{{route('pharmacist.settings.update')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <div class="col">
                                    <input id="age" type="number" min="18" max="65" class="form-control @error('age') is-invalid @enderror" name="age" value="{{ $pharmacist->age }}" required autocomplete="age" autofocus>
