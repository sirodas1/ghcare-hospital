...
<div class="row justify-content-center my-5">
    <span class="h4 text-success">Add New Doctor To Hospital</span>
</div>
            ...
            <div class="body">
                <form action="{{route('staff.doctors.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row justify-content-center my-3">
                        <span class="h5 text-secondary">Please Enter Doctor's Details.</span>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <div class="col">
                                <input id="doctor_card_number" type="text" class="form-control @error('doctor_card_number') is-invalid @enderror" name="doctor_card_number" value="{{ old('doctor_card_number') }}" required autocomplete="doctor_card_number" autofocus>
                    ...
                    <div class="form-row justify-content-center mt-5">
                        <div class="col-6">
                            <button id="submit" type="submit" class="btn btn-success w-100 disabled">Add Doctor</button>
                        </div>
                    </div>
                </form>
            </div>
