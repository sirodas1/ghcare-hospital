        ...
        <div class="col">
            <div class="card p-0">
                <div class="card-header bg-success">
                    <span class="text-light h5"><strong>Nurse -</strong></span>
                    <span class="text-light">{{$nurse->firstname . ' ' . $nurse->lastname}}</span>
                </div>
                <div class="card-body">
                    <form action="{{route('staff.nurses.update', ['id' => $nurse->id])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
