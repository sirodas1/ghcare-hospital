...
@section('page-back', route('staff.pharmacists.home'))
@section('back-check', true)

@section('content')
<div class="row justify-content-center my-5">
    <span class="h4 text-success">Add New Pharmacist To Hospital</span>
</div>
...
<div class="row justify-content-center mb-5">
    <div class="col-md-10 px-2">
        <div class="card border-success py-5">
            <div class="body">
                <form action="{{route('staff.pharmacists.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row justify-content-center my-3">
                        <span class="h5 text-secondary">Please Enter Pharmacist's Details.</span>
                    </div>
                    ...
                    <div class="form-row justify-content-center mt-5">
                        <div class="col-6">
                            <button id="submit" type="submit" class="btn btn-success w-100 disabled">Add Pharmacist</button>
                        </div>
                    </div>
                </form>
            </div>
