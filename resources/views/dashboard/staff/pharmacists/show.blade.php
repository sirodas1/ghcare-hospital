        ...
        <div class="col">
            <div class="card p-0">
                <div class="card-header bg-success">
                    <span class="text-light h5"><strong>Pharmacist -</strong></span>
                    <span class="text-light">{{$pharmacist->firstname . ' ' . $pharmacist->lastname}}</span>
                </div>
                <div class="card-body">
                    <form action="{{route('staff.pharmacists.update', ['id' => $pharmacist->id])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <div class="col">
                                    <input id="age" type="number" class="form-control @error('age') is-invalid @enderror" name="age" value="{{ $pharmacist->age }}" required autocomplete="age" autofocus>
