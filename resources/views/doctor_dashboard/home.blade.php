...
@section('content')
    ...
    <div class="row justify-content-start my-5">
        <div class="col-md-4">
            <div onclick="window.location.href = '{{route('doctor.patient.home')}}'"  class="dashboard-options cursor-pointer w-full py-4 px-4">
        ...
        <div class="col-md-4">
            <div onclick="window.location.href = '{{route('doctor.settings.home')}}'" class="dashboard-options cursor-pointer w-full py-4 px-4">
                <div class="row justify-content-between mx-1">
                    <div class="icon d-flex justify-content-center">
